...
const Services = () => {
  return (
    <section className="py-20 bg-cyan-100 dark:bg-gray-900 dark:text-white text-gray-800">
      <div className="w-11/12 mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-4">
            What <span className="text-indigo-600 dark:text-pink-500">WorkSync Pro</span> Services
          </h2>
